            ...
            <div style={styles.right}>
                {user ? (
                    <>
                        ...
                        {showRoleBadge && <span style={styles.roleBadge}>{user.role}</span>}
                ...
                <button
                    ...
                    style={{ ...styles.navBtn, ...(langHovered ? styles.navBtnHover : {}) }}
                >
                    {language === 'en' ? 'EN' : 'UA'}
                </button>
            </div>
...
const styles = {
    nav: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 32px', height: '64px', backgroundColor: '#151a1e', boxShadow: '0 2px 8px rgba(0,0,0,0.2)', position: 'sticky', top: 0, zIndex: 100 },
    left: { display: 'flex', alignItems: 'center' },
    logoLink: { color: '#ffffff', textDecoration: 'none', fontSize: '20px', fontWeight: '700' },
    right: { display: 'flex', alignItems: 'center', gap: '16px' },
    navBtn: { color: '#ffffff', textDecoration: 'none', fontSize: '14px', backgroundColor: 'transparent', border: '1px solid #ffffff', padding: '6px 16px', borderRadius: '6px', transition: 'all 0.2s ease', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' },
    navBtnHover: { backgroundColor: '#ffffff', color: '#151a1e' },
    cartBadge: { backgroundColor: '#dc2626', color: '#ffffff', borderRadius: '50%', width: '18px', height: '18px', fontSize: '11px', fontWeight: '700', display: 'flex', alignItems: 'center', justifyContent: 'center' },
    ...
    logoutBtn: { backgroundColor: 'transparent', border: '1px solid #ffffff', color: '#ffffff', padding: '6px 16px', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', transition: 'all 0.2s ease' },
    logoutBtnHover: { backgroundColor: '#ffffff', color: '#151a1e' },
    registerBtn: { backgroundColor: '#1f73b7', color: '#ffffff', padding: '7px 18px', borderRadius: '6px', textDecoration: 'none', fontSize: '14px', fontWeight: '600', transition: 'background-color 0.2s ease' },
